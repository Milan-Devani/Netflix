...
function TrendingMovieRow() {
  ...
  useEffect(() => {
    // console.log("isbtnshow", isbtnshow);
  ...
  let wishlistid; // Declare outside the block

  if (Array.isArray(wishlistitem) && wishlistitem.length > 0) {
    wishlistid = wishlistitem[0]?.id;
    // console.log("wishlistid", wishlistid);
  } else {
    // console.log("wishlistitem is not a valid array or is empty");
  }

  let selectedMovieDetailsid = selectedMovieDetails.id;

  if (wishlistid === selectedMovieDetailsid && !isbtnshow) {
    setBtnshow(true);
  }

  // console.log("selectedMovieDetailsid", selectedMovieDetailsid);
