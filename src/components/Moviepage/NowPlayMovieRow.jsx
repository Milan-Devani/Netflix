        ...
        <div className="">
          ...
          >
            <div className="flex gap-[10px]">
              {Nowplaymovies?.filter((movie) => movie.backdrop_path).slice(0, 9).map((movie, index) => (
...
export default NowPlayMovieRow;
