...
function TvshowFavoriteslist() {
  ...
  const tvshowfavoritelist = Favoriteitem.filter(
  ...
  // console.log("tvshowfavoritelist", tvshowfavoritelist);
      ...
      <div className="Trending-Today min-h-[235px]">
        ...
        <div className="">
          <div className="flex gap-[10px]">
            {tvshowfavoritelist?.map((tvshow, index) => (
...
export default TvshowFavoriteslist;
